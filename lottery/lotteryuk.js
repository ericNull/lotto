...
request('https://www.national-lottery.com/euromillions/past-results', function (error, response, body) {

  var $ = cheerio.load(body);
  var area = $(".euromillions-ball");
  console.log(typeof(area));
  var aream = $(".euromillions-lucky-star");
